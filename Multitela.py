...
class Main(QMainWindow, Ui_Main):
    ...
    def botaoCadastra(self):
        ...
        if not(nome == '' or CPF == '' or Sobrenome == ''):
            p = Cliente(nome, 1, Sobrenome, CPF, 0)
    ...
    def BotaoLogar(self):
        numero = self.tela_cadastro.lineEdit.text()
        cpf = self.tela_cadastro.lineEdit_2.text()
    ...
    def menu(self, pessoa):
        ...
        self.tela_usuario.pushButton.clicked.connect(self.botaoSacar(pessoa))
        self.tela_usuario.pushButton_2.clicked.connect(self.botaoDepositar(pessoa))
        self.tela_usuario.pushButton_3.clicked.connect(self.botaoTranferir(pessoa))
        self.tela_usuario.pushButton_4.clicked.connect(self.botaoExtrato(pessoa))
